            ...
            if (ready.Count > 0 && _ruleEngine is not null)
            {
                var defs = ready.Select(b =>
                {
                    ...
                    return new RuleDef(
                        ...
                        ScriptId: scriptId,  // 指向 ScriptLibrary 中的可执行模块
                        MinLevel: 0,
                        MaxLevel: 0,
                        RequiredClass: null,
                        ItemRequired: null,
                        ...
                        {
                            ["mapNumber"] = b.MapNumber.ToString(),
                        },
                        AutoGenerated: true,
